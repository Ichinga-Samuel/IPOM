...
def model(TPd, op):
    try:
        ...
        if 195 <= TPp <= 1400:
            ...
            Dsf = 0.4
        s = Dsf/2  # screw Pitch, in m
        dsc = Dsf / 3.624  # depth of the screw flight, in m
        ds = Dsf - (2 * dsc)  # diameter of the screw shaft, in m
        Dm = ds + dsc  # mean thread diameter
        ...
        Vsf = (Ls * dsc * tf) * ns  # Total volume of the screw flight, in m^3
        ...
        Ap = pi * Dm * ns * dsc  # Pressing Area, in m^2
        ...
        DigesterParameters = {'Number of batches for the digestion operation per hour': [nd, 'batch/hr'],
                              ...
                              'Standard inner diameter of digester membrane': [Di * 1000, 'mm'],
                              'Standard outer diameter of digester membrane': [Do * 1000, 'mm'],
                              'Standard inner diameter of digester barrel': [Ddi * 1000, 'mm'],
                              'Pitch of the digester beaters': [Ldmp * 1000, 'mm'],
                              'Length of digester discharge opening': [wd * 1000, 'mm'],
                              'Width of digester discharge opening': [Bd * 1000, 'mm'],
                              'length of digester beaters': [Ldb * 1000, 'mm'],
                              'Length of digester and cake breaker membrane': [Lm * 1000, 'mm'],
                              'Number of digester beaters': [ndb, ''],
                              'Standard diameter of digester beaters': [Do1 * 1000, 'mm'],
                              'Length of LHS Extension of digester shaft': [L1 * 1000, 'mm'],
                              'Length of RHS Extension of digester shaft': [L3 * 1000, 'mm'],
                              'Length of digester shaft': [Ld * 1000, 'mm'],
        ...
        SeparatorParameters = {'length of auger membrane': [Lam * 1000, 'mm'],
                               'length of the separator pulp discharge chute': [La * 1000, 'mm'],
                               'Standard outer diameter of auger membrane': [dam * 1000, 'mm'],
                               'Standard internal diameter of auger membrane': [dami * 1000, 'mm'],
                               'Pitch of helix on the auger membrane': [pam * 1000, 'mm'],
                               'Flow velocity of palm nuts towards its discharge opening': [vn, 'm/s'],
                               'External diameter of cake breaker membrane': [Dco, 'mm'],
                               'Length of the cake breaker beaters': [Lcb * 1000, 'mm'],
                               'Number of cake breaker beaters': [ncb, ''],
                               'Diameter of cake breaker beaters': [Dcb * 1000, 'mm'],
                               'Inner diameter of cake breaker membrane': [Dci * 1000, 'mm'],
                               'Effective length of the separator chamber top': [a * 1000, 'mm'],
                               'Effective length of the separator chamber base': [b * 1000, 'mm'],
                               'Height of digester discharge chute': [hd * 1000, 'mm'],
                               'Distance of discharge chute of the digester': [L4 * 1000, 'mm'],
        ...
        ScrewPressParameters = {'Internal diameter of screw press barrel': [Dsf * 1000, 'mm'],
                                'Screw Pitch': [s * 1000, 'mm'],
                                'depth of the screw flight': [dsc * 1000, 'mm'], 'diameter of the screw shaft': [ds * 1000, 'mm'],
                                'mean thread diameter': [Dm * 1000, 'mm'], 'length of the barrel': [Lp * 1000, 'mm'],
                                'number of screw turns': [ns, ''], 'helix angle of the screw': [Af, 'degrees'],
                                'screw channel width': [wc * 1000, 'mm'], 'flight land width': [tf * 1000, 'mm'],
                                'diameter of screw press shaft': [ds1, 'mm']}

        PulleyParameters = {'Diameter of the pulley on the digester speed reducer': [Ddp1 * 1000, 'mm'],
                            'Diameter of the digester driving pulley': [Ddp2 * 1000, 'mm'],
                            'Diameter of the cake breaker pulley': [Dcp * 1000, 'mm'],
                            'Diameter of auger Auger driven pulley': [Dap * 1000, 'mm'],
                            'Diameter of screw press speed reducer pulley': [Drp * 1000, 'mm'],
                            'Diameter of screw press pulley (if speed reducer is not used)': [Drp1 * 1000, 'mm']}

        BeltParameters = {'Minimum center distance between electric motor and digester shafts': [C1 * 1000, 'mm'],
                          'Minimum center distance between Digester and cake breaker shafts': [C2 * 1000, 'mm'],
                          'Minimum center distance between cake breaker and auger shafts': [C3 * 1000, 'mm'],
                          'Minimum center distance between auger and screw press shafts': [C4 * 1000, 'mm'],
                          'pitch length of electric motor/digester speed reducer drive belt': [Lb1 * 1000, 'mm'],
                          'pitch length of the digester/cake breaker drive belt': [Lb2 * 1000, 'mm'],
                          'pitch length of the cake breaker/auger drive belt': [Lb3 * 1000, 'mm'],
                          'pitch length of the auger/screw press drive belt': [Lb4 * 1000, 'mm'],
...
if __name__ == '__main__':
    ...
    from report.report_builder import BuildDoc
    results = format_results(p, 4080)
    filename = results['filename']
    BuildDoc(results, filename)
